...
map.getView().fit([-1.976949, 10.710787, 18.650636, 24.056643], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Régions du Niger</h2>';
        return titleElement;
    })(),
